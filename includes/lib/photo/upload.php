<?php
	...
	function handleUpload()
	{
		...
		$targetFile =  str_replace('//','/',$targetPath) . tools::slugify($_GET['qqfile']);
		$numero = "";
		$extention = "";
		$nomFichier = "";
		$temps = explode('.', tools::slugify($_GET['qqfile']));
		...
		tools::changeAccesAuthorisation($targetPath);
		$file->save($targetFile);
		$fichier = str_replace(str_replace('\\', '/', ANNONCES_HOME_DIR), '', $targetFile);
