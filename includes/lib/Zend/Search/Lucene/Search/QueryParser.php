...
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Term.php';

/** Zend_Search_Lucene_Search_Query_MultiTerm */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/MultiTerm.php';

/** Zend_Search_Lucene_Search_Query_Boolean */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Boolean.php';

/** Zend_Search_Lucene_Search_Query_Preprocessing_Phrase */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Preprocessing/Phrase.php';

/** Zend_Search_Lucene_Search_Query_Preprocessing_Term */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Preprocessing/Term.php';

/** Zend_Search_Lucene_Search_Query_Preprocessing_Fuzzy */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Preprocessing/Fuzzy.php';

/** Zend_Search_Lucene_Search_Query_Wildcard */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Wildcard.php';

/** Zend_Search_Lucene_Search_Query_Range */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Range.php';

/** Zend_Search_Lucene_Search_Query_Fuzzy */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Fuzzy.php';

/** Zend_Search_Lucene_Search_Query_Empty */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Empty.php';

/** Zend_Search_Lucene_Search_Query_Insignificant */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/Query/Insignificant.php';

/** Zend_Search_Lucene_Search_QueryLexer */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/QueryLexer.php';

/** Zend_Search_Lucene_Search_QueryParserContext */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/QueryParserContext.php';

/** Zend_Search_Lucene_FSM */
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/FSM.php';
...
class Zend_Search_Lucene_Search_QueryParser extends Zend_Search_Lucene_FSM
{
    ...
    public static function parse($strQuery, $encoding = null)
    {
        ...
        require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Search/QueryParserException.php';
        try {
