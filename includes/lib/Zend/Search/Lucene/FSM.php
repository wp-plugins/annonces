...
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/FSMAction.php';
...
abstract class Zend_Search_Lucene_FSM
{
    ...
    public function setState($state)
    {
        if (!isset($this->_states[$state])) {
            require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Exception.php';
