...
require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Document/OpenXml.php';
...
class Zend_Search_Lucene_Document_Docx extends Zend_Search_Lucene_Document_OpenXml {
    ...
    public static function loadDocxFile($fileName, $storeContent = false) {
        if (!is_readable($fileName)) {
        	require_once ABSPATH.'wp-content/plugins/'.Basename_Dirname_AOS.'/includes/lib/Zend/Search/Lucene/Document/Exception.php';
